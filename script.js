...
const i18n = {
  en: {
    'hero.eyebrow':   'SYS_001 // BGDLIB.PLATFORM',
    'hero.title':     'Two ribbons.<br><em>One platform.</em>',
    'hero.sub':       'Community posts + industry news. Filtered by engine, role, and level. Signal, not noise.',
    'hero.cta':       'Notify on launch →',
    'hero.scroll':    'Scroll',
    'about.label':    '[ 002 ] // OVERVIEW',
    'about.title':    'One platform.<br>All gamedev.',
    'about.body':     'BGDLib is a mobile gamedev platform. Built with .NET MAUI for Android. Two feeds: Main Ribbon — community posts, voting, comments, vacancies; RSS News Ribbon — 30+ industry sources aggregated locally and filtered by engine and role.',
    ...
    'feat1.title': 'MAIN RIBBON',     'feat1.badge': '// COMMUNITY',
    'feat1.desc': 'Community posts, voting, comments and tags. ASP.NET Core 9 backend + PostgreSQL. Filtered by engine and role. Your gamedev hub.',
    'feat2.title': 'RSS RIBBON',
    'feat2.desc': '30+ external sources parsed directly on device. Unity, Godot, 80.lv, Habr, Unreal Blog and more. Offline cache via SQLite. No backend required.',
    ...
    'feat4.title': 'VACANCIES',
    'feat4.desc': 'Job listings filtered by level, engine, and format. Junior / Middle / Senior. Remote or office. Direct link to source.',
  ...
  ru: {
    'hero.eyebrow':   'SYS_001 // BGDLIB.PLATFORM',
    'hero.title':     'Две ленты.<br><em>Одна платформа.</em>',
    'hero.sub':       'Посты сообщества + новости индустрии. Фильтрация по движку, роли и уровню. Сигнал без шума.',
    'hero.cta':       'Уведомить о запуске →',
    'hero.scroll':    'Вниз',
    'about.label':    '[ 002 ] // ОБЗОР',
    'about.title':    'Одна платформа.<br>Весь геймдев.',
    'about.body':     'BGDLib — мобильная геймдев-платформа. .NET MAUI, Android. Две ленты: Main Ribbon — посты сообщества, голосование, комментарии, вакансии; RSS News Ribbon — 30+ источников индустрии, агрегация прямо на устройстве, кэш в SQLite.',
    ...
    'feat1.title': 'MAIN RIBBON', 'feat1.badge': '// COMMUNITY',
    'feat1.desc': 'Посты сообщества, голосование, комментарии и теги. Backend ASP.NET Core 9 + PostgreSQL. Фильтрация по движку и роли. Твой геймдев-хаб.',
    'feat2.title': 'RSS RIBBON',
    'feat2.desc': '30+ внешних источников, парсинг прямо на устройстве. Unity, Godot, 80.lv, Habr, Unreal Blog и другие. Офлайн-кэш в SQLite. Backend не нужен.',
    ...
    'feat4.title': 'ВАКАНСИИ',
    'feat4.desc': 'Вакансии с фильтрами по уровню, движку и формату. Junior / Middle / Senior. Удалёнка или офис. Прямая ссылка на источник.',
